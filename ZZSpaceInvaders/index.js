 ;(function(){
    ...
    Game.prototype = {
        ...
        tick: function(){
            ...
            if(elapsedTime > this.updateMs * 100 + 30 * this.waits) return this.pause();
        ...
        update: function(){
            ...
            for(var i = 0; i < this.invaders.length; ++i){
                ...
                if(Math.random() < 0.0019 * this.invaders[i].health) this.invaders[i].shoot();
    ...
    function Drawer(canvasId, game){
        ...
        for(var i = 0; i < this.imageSrcs.length; ++i){
            ...
            this.imgs[str].src = 'http://www.towc.eu/game/invaders/images/' + str + '.png';
    ...
    function Sounds(game){
        ...
        try{
            for(var i = 0; i < this.soundSrcs.length; ++i){
                ...
                request.open('GET', 'http://www.towc.eu/game/invaders/sounds/' + this.soundSrcs[i] + '.mp3', true);
    ...
    function Player(game){
        ...
        this.pos = new Vec(game.ww / 2, game.hh - 2);
    ...
    Upgrade.prototype = {
        ...
        use:function(){
            var img=document.createElement('img');
          img.src='http://www.towc.eu/game/invaders/images/U'+this.type+'.png';
    ...
    function Bullet(parent, isInvader, vx, vy, power, pierce){
        ...
        this.size = isInvader ? {w: 1, h: 1} : {w: 5, h: 7};
